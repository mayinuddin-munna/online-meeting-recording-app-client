            ...
            <Tabs>
                ...
                <TabPanel>
                    ...
                    <div className="flex justify-center items-center flex-col-reverse md:flex-row lg:flex-row mb-5 ">
                        <div className="ms-5">
                            <h1 className="text-5xl font-bold mb-4 md:text-7xl lg:text-7xl text-center">Connect with calling</h1>
                            <p className="text-left leading-9 text-2xl text-slate-600 ms-5 me-5 hidden md:hidden lg:block">
                ...
                <TabPanel>
                    ...
                    <div className="flex justify-center items-center flex-col-reverse md:flex-row lg:flex-row mt-8 mb-5 ">
                        <div className="ms-5">
                            <h1 className="text-5xl font-bold mb-3 md:text-7xl lg:text-7xl text-center">Meet from anywhere</h1>
                            <p className="text-left leading-9 text-2xl text-slate-600 ms-5 me-5 hidden md:hidden lg:block">
