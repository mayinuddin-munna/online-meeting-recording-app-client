    ...
    <div className="h-[100vh]">
      <div className=" bg-[#111827] h-[40vh] flex items-center text-center">
        <div className="container mx-auto text-white md:w-1/2">
          <h1 className="text-3xl font-semibold mb-4">No Worries, No Risk</h1>
          <p>
        ...
        <div className="container mx-auto text-white flex items-center flex-col md:flex-row gap-8 md:gap-4">
          ...
          <div className="flex-1">
            <div className="flex items-start gap-6">
              ...
              <div className="text">
                <h2 className="text-xl font-semibold mb-2">Seamless Multi-Device Integration</h2>
            ...
            <div className="flex items-start gap-6 mt-4">
              ...
              <div className="text">
                <h2 className="text-xl font-semibold mb-2">Adaptive Bandwidth Optimization</h2>
                <p>
