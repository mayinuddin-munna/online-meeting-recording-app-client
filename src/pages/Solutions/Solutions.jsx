            ...
            <div className="container mx-auto grid gap-8 grid-cols-1 md:grid-cols-1 lg:grid-cols-1">
              ...
              >
                ...
                <div className="text-left">
                  ...
                  <p className="text-gray-600">
                    Engage students with interactive online classes, real-time
                    quizzes, and collaborative virtual whiteboards for an
              ...
              >
                ...
                <div className="text-left">
                  ...
                  <p className="text-gray-600">
                    Provide instant tech support through screen sharing and
                    remote access tools, resolving IT issues efficiently and
                    minimizing downtime.
                  </p>
                </div>
              </div>
              ...
              >
                ...
                <div className="text-left">
                  ...
                  <p className="text-gray-600">
                    Enhance customer satisfaction by offering personalized video
                    calls, sharing product demos, and resolving issues
                    face-to-face, building stronger connections.
                  </p>
                </div>
              </div>
              {/* feature 4 */}
              ...
              >
                ...
                {/* Content */}
                <div className="text-left">
                  <h3 className="text-xl font-semibold mb-2">For Sales</h3>
                  <p className="text-gray-600">
                    Showcase products and services virtually, share detailed
                    demos, and close deals faster by engaging potential
                    customers in real-time presentations.
                  </p>
                </div>
              </div>
              {/* feature 5 */}
              ...
              >
                ...
                <div className="text-left">
                  ...
                  <p className="text-gray-600">
                    Foster creative collaboration among teams by sharing
                    marketing materials, brainstorming ideas, and discussing
                    strategies during online meetings.
                  </p>
                </div>
              </div>
              {/* feature 6 */}
              ...
              >
                ...
                {/* Content */}
                <div className="text-left">
                  <h3 className="text-xl font-semibold mb-2">For Healthcare</h3>
                  <p className="text-gray-600">
                    Conduct secure telemedicine consultations with patients,
                    share medical reports, and offer professional medical advice
                    remotely for better healthcare access.
                  </p>
                </div>
              </div>
              {/* feature 7 */}
              ...
              >
                ...
                <div className="text-left">
                  ...
                  <p className="text-gray-600">
                    Foster creative Ensure data privacy during financial
                    discussions with secure virtual meetings, document sharing,
                    and encrypted communication for confidential matters.
                  </p>
                </div>
              </div>
            </div>
