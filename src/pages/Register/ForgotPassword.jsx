...
const ForgotPassword = () => {
    ...
    return (
        <div className="flex justify-center items-center p-10 lg:p-48 md:p-20 h-screen ms-0" style={{ backgroundImage: `url(${backgroundImage})`, backgroundSize: 'cover' }}>
            <div className='flex flex-container md:flex-row rounded'>
                {/* left div */}
                <div className="flex flex-col p-8 bg-primary rounded-t-lg w-1/2 justify-between md:rounded-l-lg md:w-1/2 " style={{ backgroundColor: '#084B3E', height: '600px' }}>
...
>>>>>>> 159014a0698ded3d1c6d2ec4e205dd25720716c5
