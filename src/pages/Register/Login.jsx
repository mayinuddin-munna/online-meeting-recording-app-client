  ...
  return (
    ...
    >
      <div className="flex flex-container md:flex-row rounded">
        {/* left div */}
        <div
          className="flex flex-col p-8 bg-primary rounded-l-lg w-1/2 md:rounded-l-lg justify-between md:w-1/2"
          style={{ backgroundColor: "#084B3E" }}
        >
          ...
          >
            <div className="flex flex-container md:flex-row rounded">
              ...
              >
                ...
                <p className="text-left text-[30px] items-center justify-between text-yellow-100 mb-0">
                  Your text here. Lorem ipsum dolor sit amet consectetur
                  adipisicing elit.
                </p>
              </div>
              {/* right div */}
              <div className=" bg-white rounded-r-lg p-8 rounded shadow-md w-1/2">
                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                  ...
                  <Link to="/forget-password">
                    <p className="mb-6">
                      <span className=" text-green-500">Forget Password</span>
                    </p>
                  </Link>
                  <div>
                    <button
