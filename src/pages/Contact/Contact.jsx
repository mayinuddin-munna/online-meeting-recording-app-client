...
const Contact = () => {
  return (
    <>
      <div className="container grid grid-cols-1 lg:grid-cols-2 justify-items-center mx-auto text-slate-600 mt-[130px] mb-8 lg:pt-50 lg:h-[60vh]">
        <div className="p-10">
          ...
          <h3 className="text-xl font-bold mt-4 pl-4 mb-4 border-l-4 border-green-500">
            Support
          </h3>
          <p>
            Please visit our{" "}
