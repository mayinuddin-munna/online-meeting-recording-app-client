...
const FeatureFacilities = () => {
    return (
        <section className='grid grid-cols-4 justify-items-center bg-white text-black p-24 '>
            ...
            <div className='w-8/12 p-4 lg:p-8 shadow-xl text-center
            ...
            <div className='w-8/12 p-4 lg:p-8 shadow-xl text-center
            rounded-md bg-gradient-to-t from-blue-100 to-cyan-100'>
                <h1 className='font-semibold text-3xl mb-2'>Instant Video Conference</h1>
                <p className=''>Instant Video collaboration with your team anywhere at anytime.</p>
            </div>
